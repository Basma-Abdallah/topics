...
@section('content')
  ...
  <div class="container my-5">
        <div class="mx-2">
            ...
            <form action="{{route('addTopic')}}" method="post" class="px-md-5" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group mb-3 row">
                    ...
                    <div class="col-md-10">
                        <select name="category" id="" class="form-control py-1">
                            <option value="">Select category</option>
                            @foreach($categories as $category)
                            <option value="{{ $category['id'] ,old('category')}}"  >{{ $category['CategoryName']}}</option>
                            @endforeach
                        </select>
                        @error('category')
                            <div class="alert alert-warning">{{$message}}</div>
                ...
                <div class="form-group mb-3 row">
                    ...
                    <div class="col-md-10">
                        <input type="checkbox" class="form-check-input" style="padding: 0.7rem;"   name="Trending" @checked(old('Trending')) />
                    </div>
                </div>
                <div class="form-group mb-3 row">
