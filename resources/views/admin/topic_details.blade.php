            ...
            <div class="p-5">
                <div class="container-fluid g-0 pt-3 pb-5 px-lg-5 px-md-3 px-1">
                    <div class="img-wrapper" >
                      <img src="{{ asset('assets/admin/images/topics/' . $topic->image) }}" class="rounded image-center border-5 rounded-4"
                       alt="{{$topic->Title}}"  />
                    </div>
                    <!-- article -->
                    <div class="mx-auto pt-4" style="max-width: 1225px">
                      <article class="mx-md-4 ">
                        ...
                        <div class="text-md-end">
                          <a class="btn mt-4 btn-secondary text-white fs-5 fw-bold border-0 py-2 px-md-5" href="{{route('topics')}}"> Back to All topics </a>
                        </div>
                      </article>
                    </div>
              </div>
