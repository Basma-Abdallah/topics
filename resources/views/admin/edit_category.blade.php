...
<div class="container my-5">
    <div class="mx-2">
        ...
        <form action="{{route('updateCat' , $Categories->id)}}" method="post" class="px-md-5">
        ...
        @method('put')
            <div class="form-group mb-3 row">
                ...
                <div class="col-md-10">
                    <input type="text" placeholder="e.g. Computer Science" class="form-control py-2" name="CategoryName" value="{{old('CategoryName' , $Categories->CategoryName)}}"  />
                    @error('CategoryName')
