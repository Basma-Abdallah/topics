                ...
                <table class="table table-hover display" id="_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$topic->Trending}}</td>
                            <td class="text-center"><a class="text-decoration-none text-dark" href="{{route('editTopic' , $topic->id)}}"><img src="{{asset('assets/admin/images/edit-svgrepo-com.svg')}}"></a></td>
                            <td class="text-center">
                            <!--  -->
                        <a class="text-decoration-none text-dark" href="{{route('TopicDelete' , $topic->id)}}" onclick=" return confirm('Are you sure you want to delete?')" ><img src="{{asset('assets/admin/images/trash-can-svgrepo-com.svg')}}" ></a></td>
                            @endforeach
                    </tbody>
                </table>
            </div>
