    ...
    public function topicsList()
            {
                    ...
                    $topicA = Topic::where(['Published'=> '1' , 'Trending'=> '1'])->orderBy('created_at', 'desc')->offset(0)->limit(1)->get();
                    $topicB = Topic::where(['Published'=> '1' , 'Trending'=> '1'])->orderBy('created_at', 'desc')->offset(1)->limit(1)->get();
                    //dd($topicA);
     ...
     public function index()
            {
                    $testimonials= Testimonial::where('Published' , '1')->orderBy('created_at', 'desc')->offset(0)->limit(3)->get();

                    $topicsA =Topic::where(['Published'=> '1'])->orderBy('NumberOfViews', 'desc')->offset(0)->limit(1)->get();
                    $topicsB =Topic::where(['Published'=> '1'])->orderBy('NumberOfViews', 'desc')->offset(1)->limit(1)->get();
    ...
    public function markAsRead($id)
            {
                    ...
                    if (session()->has('marked_' . $id)) {
                        ...
                        session()->forget('marked_' . $id);
                    } else {
                        $topic->increment('NumberOfViews');
                        session()->put('marked_' . $id, true);
                    }
